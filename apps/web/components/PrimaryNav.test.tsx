 ...
 * T73④ AC-084⑥ — 아직 구현되지 않은 화면(Mediate/Profile/Terminology 외 전부, `docs/Tasks.md`
 * T27/T31/T41/T42/T52/T72/Feedback 담당 태스크가 모두 `todo`)의 항목은 렌더하지 않는다
 * (비활성/빈/404 링크 금지 — disabled 속성이 아니라 미렌더).
 */
...
describe('PrimaryNav — T73③/④', () => {
  it('구현된 화면(Mediate/Profile/Terminology)은 렌더된다', () => {
    render(<PrimaryNav />);
  ...
  it('아직 구현되지 않은 화면(Pair Protocols/Meeting Times/Decisions/Feedback/발송 내역/관측 표본)은 렌더되지 않는다 — AC-084⑥', () => {
    render(<PrimaryNav />);
    for (const label of [
      'Pair Protocols',
      'Meeting Times',
